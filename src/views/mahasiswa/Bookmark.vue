<template>
  <v-container class="my-4 d-flex justify-center flex-column">
    <v-card class="px-4 py-3 mb-5">
      ...
      <template v-if="emoduls == null">
        <h1 class="text-h6 text-center font-weight-light my-3">
          Bookmark Kosong
        </h1>
      </template>
        ...
        <v-row class="my-2">
          ...
          >
            <v-card>
              <v-img
                :src="
                  emodul.prodis.image == null
                    ? `${beUrl}/storage/images/defaultBanner.webp`
                    : `${beUrl}/storage/images/${emodul.prodis.image}`
                "
                height="100"
                cover
              ></v-img>
              ...
              <v-card-subtitle class="text--primary text-caption pb-0">
                {{ emodul.matakuliahs.matakuliah }}
              </v-card-subtitle>
              <v-card-subtitle class="text--primary text-caption pb-0 pt-1">
                {{ emodul.deskripsi }}
              </v-card-subtitle>
              <v-card-actions class="d-flex justify-end ma-none">
                <router-link class="apparance-none" :to="emodul.slug">
